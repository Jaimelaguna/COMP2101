function System_Info1 {
	Write-Host "     COMPUTER SYSTEM     " -ForegroundColor blue -BackgroundColor white
...
function Operating_System1 {
	Write-Host "     OPERATING SYSTEM     " -ForegroundColor blue -BackgroundColor white
...
function Memory1 {
	Write-Host "     MEMORY     " -ForegroundColor blue -BackgroundColor white
	$TotalMemory = 0
...
function Drives1 {
	Write-Host "     DRIVES     " -ForegroundColor blue -BackgroundColor white
...
function Network1 {
	Write-Host "     NETWORK ADAPTER     " -ForegroundColor blue -BackgroundColor white -NoNewline
	JaimeLagunaLab3.ps1
}
function Video_Cards1 {
	Write-Host "     VIDEO CARDS     " -ForegroundColor blue -BackgroundColor white
