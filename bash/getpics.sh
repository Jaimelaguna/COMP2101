...
echo "Getting pics from zip file....."
wget -q -O ~/public_html/pics/pics.zip http://zonzorp.net/pics.zip && unzip -d ~/public_html/pics -o -q ~/public_html/pics/pics.zip && rm ~/public_html/pics/pics.zip && echo "---> zip file imported, pics uncompressed, and zip file deleted sucessfully"
echo "Getting pics from tar file....."
wget -q -O ~/public_html/pics/pics.tgz https://zonzorp.net/pics.tgz && tar -xf ~/public_html/pics/pics.tgz -C ~/public_html/pics && rm ~/public_html/pics/pics.tgz && echo "---> tar file imported, pics uncompressed, and tar file deleted sucessfully"
# Task 1: Improve this script to also retrieve and install the files kept in the https://zonzorp.net/pics.tgz tarfile
